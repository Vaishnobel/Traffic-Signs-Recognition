...
Original file is located at
    https://colab.research.google.com/drive/1tdFI8Z6vgeQ89WaO6AJNGN1s8VTCI5xE
"""
...
#Compilation of the model model.compile(loss=’categorical_crossentropy’, optimizer=’adam’, metrics=[‘accuracy’])
